...
```
[root@ip-172-31-42-112 app]# more /var/log/cloudera-scm-server/cloudera-scm-server.log
2017-11-03 01:43:18,802 INFO main:com.cloudera.server.cmf.Main: Starting SCM Server. JVM Args: [-Dlog4j.configuration=file:/etc/cloudera-scm-server/log4j.properties, -Dfile.encoding=UTF-8, -D
...
```
2017-11-03 01:44:55,448 INFO WebServerImpl:com.cloudera.server.cmf.WebServerImpl: Started Jetty server.
